...
<input name="apellidos" autocomplete="on" x-autocompletetype="apellidos" value="' . $value . '" class="formI ftext1" id="df_2" onchange="sendDat(this.id,this.value);" tabindex="' . $tab . '"/>
</div>
